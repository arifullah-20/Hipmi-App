...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset ('assets1/img/favicon/favicon.ico')}}" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">HIPMI</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                  ...
                  <div data-i18n="Layouts">Data Hipmi</div>
                </a>

                <ul class="menu-sub">
                  {{-- <li class="menu-item">
                    <a href="/profile-index" class="menu-link">
                      <div data-i18n="Without menu">Profil</div>
                    </a>
                  </li> --}}
                  <li class="menu-item">
                    <a href="/vismis-index" class="menu-link">
                      <div data-i18n="Without navbar">Visi Misi</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="/perusahaan-index" class="menu-link">
                      <div data-i18n="Without navbar">Perusahaan Tergabung</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="/sejarah-index" class="menu-link">
            ...
            <li class="menu-item ">
              ...
              {{-- <li class="menu-item">
                <a href="/medsos-index" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-home-circle"></i>
                  <div data-i18n="Analytics">Medsos</div>
                </a>
              </li> --}}


              {{-- <li class="menu-item">
                <a href="/berita-index" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-home-circle"></i>
                  <div data-i18n="Analytics"> Data Berita</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="/kategori-index" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-home-circle"></i>
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  ...
                  <li class="menu-item">
                    <a href="/kategori-index" class="menu-link">
                      <div data-i18n="Without navbar">Kategori Berita</div>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                  <i class="menu-icon tf-icons bx bx-layout"></i>
                  <div data-i18n="Layouts">Organisasi</div>
                </a>

                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="/struktur-index" class="menu-link">
                      <div data-i18n="Without menu">Struktur</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="/jabatan-index" class="menu-link">
                      <div data-i18n="Without navbar">Jabatan</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="/anggota-index" class="menu-link">
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="/video-index" class="menu-link">
                      <div data-i18n="Without menu">Video</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="/foto-index" class="menu-link">
                      <div data-i18n="Without navbar">Foto</div>
                    </a>
                  </li>
                </ul>
              </li>
            ...
            <li class="menu-item">
                <a href="/perusahaan-index" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-home-circle"></i>
                  <div data-i18n="Analytics">Perusahaan Tergabung</div>
                </a>
            </li> --}}
